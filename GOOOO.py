...
Graph01=Data.loc[Selected_Data['Terminal'] == 'T1']
Graph01=np.array(Graph01)
Graph02=Data.loc[Selected_Data['Terminal'] == 'T2']
Graph02=np.array(Graph02)
Graph03=Data.loc[Selected_Data['Terminal'] == 'T4']
Graph03=np.array(Graph03)
...
for i in C:
    if min_Conducteur<=i:
        min_Conducteur=i
min_Conducteur+=1
min_Conducteur=(max(C1)+max(C2)+max(C3))
